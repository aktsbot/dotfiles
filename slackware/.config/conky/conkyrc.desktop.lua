...
${image $HOME/.config/conky/images/tux01.png -p 100,240 -s 80x80}
...
${color gold}XP0:  ${color }$alignr${fs_used /media/akts_disks/sda1_xp0}/${fs_size /media/akts_disks/sda1_xp0}
${fs_bar 4 /media/akts_disks/sda1_xp0}
${color gold}XP1:  ${color }$alignr${fs_used /media/akts_disks/sda2_xp1}/${fs_size /media/akts_disks/sda2_xp1}
${fs_bar 4 /media/akts_disks/sda2_xp1}
